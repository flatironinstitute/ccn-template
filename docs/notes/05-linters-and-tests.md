...
!!! warning "Beware of Auto-generated Scripts, Part Two"
    Just as with [docstrings style](04-docstrings.md/#docstring-linting), auto-generated scripts may not adhere to linting standards, leading to failures. For instance, the `version.py` script generated by `setuptools-scm` ([packaging note](02-packaging.md)) doesn't comply with `black` linting standards.
